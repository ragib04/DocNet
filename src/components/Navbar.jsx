  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <div className='flex items-center gap-4'>
            ...
            :<button onClick = {() => navigate('/login')} className='bg-indigo-500 text-white px-8 py-3 rounded-full cursor-pointer font-light hidden md:block'>Create account</button>
}
        </div>
    </div>
  )
