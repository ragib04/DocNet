...
return (
    <div className='flex flex-col md:flex-row flex-wrap bg-indigo-500 rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-3 text-white tem-sm font-light'>
                <img className='w-28' src={assets.group_profiles} alt=""/>
                <p>
                Simply browse through our extensive list of <br />trusted doctors,<br /> schedule your appointment hassle-free.
                </p>
            </div>
